...
| `openarm_left_ik` | Enactic OpenArm v2.0 (left) | **approximate-SRS 7R** (non-Z*Z wrist) | `openarm_left_base_link` | `openarm_left_ee_base_link` |
| `openarm_right_ik` | Enactic OpenArm v2.0 (right) | **approximate-SRS 7R** (non-Z*Z wrist) | `openarm_right_base_link` | `openarm_right_ee_base_link` |
<!-- /AUTOGEN -->
...
| OpenArm L (**approximate-SRS 7R**) | **refuses** ("only 1-6R") | 57.69 ± 0.92 ms / FK 1e-12 / 21-67 sols |
| OpenArm R (**approximate-SRS 7R**) | **refuses** ("only 1-6R") | 56.70 ± 0.67 ms / FK 1e-12 / 22-59 sols |
<!-- /AUTOGEN -->
