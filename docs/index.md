...
The rebuild draws on the subproblem-decomposition approach of Elias & Wen ([IK-Geo](https://arxiv.org/abs/2211.05737), 2022/2025), Ostermeier ([EAIK](https://arxiv.org/abs/2409.14815), 2024), and Husty & Pfurner (2007), and on the algebraic-elimination pipeline of Raghavan & Roth (1990) + Manocha & Canny (1994). The original `ikfastpy` project was a port of Rosen Diankov's IKFast (Carnegie Mellon, OpenRAVE); the vendored tree was removed in [#84](https://github.com/siddhss5/ikfastpy/issues/84) once the rewrite covered every case it was needed for. See the [Bibliography](bibliography.md) for primary sources.
