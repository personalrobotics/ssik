...
Guide for getting your specific arm working with ssik — beyond the <!-- AUTOGEN:arm_count -->52<!-- /AUTOGEN --> prebuilts. Three real-world friction points: **URDF readiness**, **link selection** (base + EE + tool), and **verification** (does the baked geometry match your robot?).

## When a prebuilt is enough vs when to `ssik build`

The <!-- AUTOGEN:arm_count -->52<!-- /AUTOGEN --> prebuilts cover **nominal manufacturer geometry with a bare flange**. They work when:
