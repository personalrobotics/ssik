...
ssik returns every analytical IK branch for a target end-effector pose. Eleven commercial arms ship as prebuilt artifacts in the wheel (UR5, Puma 560, Kinova JACO 2, KUKA iiwa LBR 14, Kinova Gen3, Franka Panda, Flexiv Rizon 4, Kassow KR810, UFactory xArm7, UFactory xArm6, Unitree Z1); any other arm is supported via "ssik build my_arm.urdf", which emits a single-file Python artifact specialised to the URDF.
