...
def _emit_solve_parity(
    ...
    # The golden gates the SOLVER, so it records the geometric solution set
    # (enumerate_windings=False, #562). Winding lifts are a deterministic
    # function of the joint limits applied after the solve, identical on both
    # sides by construction and covered by tests/test_winding_enumeration.py;
