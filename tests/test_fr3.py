"""Bulletproof validation for the fr3 fixture (auto-generated by ``ssik add-arm``).

The arm dispatches to ``seven_r.spherical_shoulder`` (tier 0) since #373 --
exact spherical-shoulder + offset-wrist. The scaffold below verifies:
...
Source URDF: ``tests/fixtures/fr3.urdf`` (vendored via ``ssik add-arm``).
"""
...
URDF_PATH = Path(__file__).parent / "fixtures" / "fr3.urdf"


def _fr3_kinbody():
    return load_urdf_kinbody_normalized(URDF_PATH, "fr3_link0", "fr3_link8")
...
def test_fr3_hand_picked_fk_closure(q_star: np.ndarray) -> None:
...
def test_fr3_random_pose_fk_closure(seed: int) -> None:
