"""Bulletproof validation for the kr210_r2700_ik fixture (auto-generated by ``ssik add-arm``).
...
**shipped artifact** (``ssik.prebuilt.kr210_r2700_ik`` -- build it with
``uv run python scripts/regen_artifacts.py --arm kr210_r2700_ik`` first):
...
``[arms.kr210_r2700_ik.known_gaps]`` entry in MANIFEST.toml documenting why.

Source URDF: ``tests/fixtures/kr210_r2700_ik.urdf`` (vendored via ``ssik add-arm``).
"""
...
URDF_PATH = Path(__file__).parent / "fixtures" / "kr210_r2700_ik.urdf"
...
def test_kr210_r2700_ik_loads_as_6dof() -> None:
    kb = _kr210_r2700_ik_kinbody()
...
def test_kr210_r2700_ik_dispatches_to_ikgeo_spherical_two_parallel() -> None:
...
def test_kr210_r2700_ik_coverage_and_fk_closure() -> None:
    ...
    art = pytest.importorskip(
        "ssik.prebuilt.kr210_r2700_ik",
        reason="build the artifact first: regen_artifacts.py --arm kr210_r2700_ik",
    )
...
def test_kr210_r2700_ik_random_pose_fk_closure(seed: int) -> None:
