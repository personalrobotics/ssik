"""Bulletproof validation for the r2000ic210l_ik fixture (auto-generated by ``ssik add-arm``).
...
**shipped artifact** (``ssik.prebuilt.r2000ic210l_ik`` -- build it with
``uv run python scripts/regen_artifacts.py --arm r2000ic210l_ik`` first):
...
``[arms.r2000ic210l_ik.known_gaps]`` entry in MANIFEST.toml documenting why.

Source URDF: ``tests/fixtures/r2000ic210l_ik.urdf`` (vendored via ``ssik add-arm``).
"""
...
URDF_PATH = Path(__file__).parent / "fixtures" / "r2000ic210l_ik.urdf"
...
def test_r2000ic210l_ik_loads_as_6dof() -> None:
    kb = _r2000ic210l_ik_kinbody()
...
def test_r2000ic210l_ik_dispatches_to_ikgeo_spherical_two_parallel() -> None:
...
def test_r2000ic210l_ik_coverage_and_fk_closure() -> None:
    ...
    art = pytest.importorskip(
        "ssik.prebuilt.r2000ic210l_ik",
        reason="build the artifact first: regen_artifacts.py --arm r2000ic210l_ik",
    )
...
def test_r2000ic210l_ik_random_pose_fk_closure(seed: int) -> None:
