"""Bulletproof validation for the ur20 fixture (auto-generated by ``ssik add-arm``).
...
Source URDF: ``tests/fixtures/ur20.urdf`` (vendored via ``ssik add-arm``).
"""
...
URDF_PATH = Path(__file__).parent / "fixtures" / "ur20.urdf"
...
def test_ur20_loads_as_6r() -> None:
    kb = _ur20_kinbody()
...
def test_ur20_dispatches_to_ikgeo_three_parallel() -> None:
...
def test_ur20_hand_picked_fk_closure(q_star: np.ndarray) -> None:
...
def test_ur20_random_pose_fk_closure(seed: int) -> None:
