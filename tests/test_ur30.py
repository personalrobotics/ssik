"""Bulletproof validation for the ur30 fixture (auto-generated by ``ssik add-arm``).
...
Source URDF: ``tests/fixtures/ur30.urdf`` (vendored via ``ssik add-arm``).
"""
...
URDF_PATH = Path(__file__).parent / "fixtures" / "ur30.urdf"
...
def test_ur30_loads_as_6r() -> None:
    kb = _ur30_kinbody()
...
def test_ur30_dispatches_to_ikgeo_three_parallel() -> None:
...
def test_ur30_hand_picked_fk_closure(q_star: np.ndarray) -> None:
...
def test_ur30_random_pose_fk_closure(seed: int) -> None:
