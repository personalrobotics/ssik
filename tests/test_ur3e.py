"""Bulletproof validation for the ur3e fixture (auto-generated by ``ssik add-arm``).
...
Source URDF: ``tests/fixtures/ur3e.urdf`` (vendored via ``ssik add-arm``).
"""
...
URDF_PATH = Path(__file__).parent / "fixtures" / "ur3e.urdf"
...
def test_ur3e_loads_as_6r() -> None:
    kb = _ur3e_kinbody()
...
def test_ur3e_dispatches_to_ikgeo_three_parallel() -> None:
...
def test_ur3e_hand_picked_fk_closure(q_star: np.ndarray) -> None:
...
def test_ur3e_random_pose_fk_closure(seed: int) -> None:
