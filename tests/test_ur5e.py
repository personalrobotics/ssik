"""Bulletproof validation for the ur5e fixture (auto-generated by ``ssik add-arm``).
...
Source URDF: ``tests/fixtures/ur5e.urdf`` (vendored via ``ssik add-arm``).
"""
...
URDF_PATH = Path(__file__).parent / "fixtures" / "ur5e.urdf"
...
def test_ur5e_loads_as_6r() -> None:
    kb = _ur5e_kinbody()
...
def test_ur5e_dispatches_to_ikgeo_three_parallel() -> None:
...
def test_ur5e_hand_picked_fk_closure(q_star: np.ndarray) -> None:
...
def test_ur5e_random_pose_fk_closure(seed: int) -> None:
