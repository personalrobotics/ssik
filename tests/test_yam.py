"""Bulletproof validation for the yam fixture (auto-generated by ``ssik add-arm``).
...
Source URDF: ``tests/fixtures/yam.urdf`` (vendored via ``ssik add-arm``).
"""
...
URDF_PATH = Path(__file__).parent / "fixtures" / "yam.urdf"
...
def test_yam_dispatches_to_ikgeo_general_6r() -> None:
...
def test_yam_hand_picked_fk_closure(q_star: np.ndarray) -> None:
...
def test_yam_random_pose_fk_closure(seed: int) -> None:
